...
exports.updatePresensi = async (req, res) => {
    try {
        ...
        // [LOGIKA BISNIS 1: Pengecekan Body Kosong Total]
        if (checkIn === undefined && checkOut === undefined && nama === undefined) {
            return res.status(400).json({
                message:
                    "Request body harus berisi minimal satu field untuk diupdate (checkIn, checkOut, atau nama).",
            });
        }
        
        // [LOGIKA BISNIS 2: Pencarian Record]
        ...
        // [LOGIKA BISNIS 3: Pembaruan Parsial]
        // Hanya update jika field ada di request body (data sudah divalidasi oleh middleware)
